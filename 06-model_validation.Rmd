...
Note: in case `SDMTools` failed to load you will have to first manually install [RTools](https://cran.r-project.org/bin/windows/Rtools/history.html) and then run this code bellow: 
```{r, eval=T,message=FALSE,warning=FALSE}
# find_rtools()
# 
