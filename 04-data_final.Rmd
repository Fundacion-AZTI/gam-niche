...
The new dataset has 29806 rows and 11 columns, and there are 139 NA's in the environmental dataset. Note also that there are some positive bathymetries that correspond to points located very close to the coast. We remove both the points with positive bathymetries and the points with NA's:
