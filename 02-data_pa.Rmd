...
unzip(here::here ("data", "spatial", "FAO_AREAS.zip"),exdir="data/spatial/FAO")
...
bathy <- marmap::getNOAA.bathy(lon1=-100,lon2=30,lat1=-41,lat2=55, resolution = 1,               keep=TRUE, antimeridian=FALSE, path= here::here("data", "spatial", "bathy"))
